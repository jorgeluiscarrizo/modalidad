...
Route::group(['middleware' => ['auth:sanctum', 'verified', 'language'], 'prefix' => 'dashboard'], function () {
    ...
    Route::get('seller-update/{slug}', SellerUpdate::class)->name('seller.update')->middleware('auth', 'role:admin');
     //ciudad
    Route::get('city', CityDashboard::class)->name('city.dashboard')->middleware('auth', 'role:admin',);
    Route::get('city-create', CityCreate::class)->name('city.create')->middleware('auth', 'role:admin');
    Route::get('city-update/{slug}', CityUpdate::class)->name('city.update')->middleware('auth', 'role:admin');
      //producto
    ...
    //cliente
    Route::get('client', ClientDashboard::class)->name('client.dashboard')->middleware('auth', 'role:admin',);
    Route::get('client-create', ClientCreate::class)->name('client.create')->middleware('auth', 'role:admin');
    Route::get('client-update/{slug}', ClientUpdate::class)->name('client.update')->middleware('auth', 'role:admin');
    //rutas
    Route::get('route', RouteDashboard::class)->name('route.dashboard')->middleware('auth', 'role:admin',);
    Route::get('route-create', RouteCreate::class)->name('route.create')->middleware('auth', 'role:admin');
    Route::get('route-update/{slug}', RouteUpdate::class)->name('route.update')->middleware('auth', 'role:admin');
    //dellevenddedor
    Route::get('detailseller', DetailsellerDashboard::class)->name('detailseller.dashboard')->middleware('auth', 'role:admin',);
    Route::get('detailseller-create', DetailsellerCreate::class)->name('detailseller.create')->middleware('auth', 'role:admin');
    Route::get('detailseller-update/{slug}', DetailsellerUpdate::class)->name('detailseller.update')->middleware('auth', 'role:admin');
    //Admin User
    ...
    //Admin User
    Route::get('note', NoteCreate::class)->name('note.create')->middleware('auth', 'role:admin');

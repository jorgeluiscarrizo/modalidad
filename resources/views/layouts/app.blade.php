    ...
    <div class="md:flex flex-col md:flex-row md:min-h-screen w-full">
        <div @click.away="open = false"
            ...
            <nav :class="{'block': open, 'hidden': !open}"
                ...
                {{--nota--}}
                <x-a-sidenav href="{{ route('note.create') }}" :active="request()->routeIs('note.create')"
                    class="text-l font-semibold tracking-widest text-primary-500 uppercase rounded-lg dark-mode:text-white focus:outline-none focus:shadow-outline">
                    <i class="fas fa-detailsellers"></i> {{ 'nota' }}
                </x-a-sidenav>
                {{--lote--}}
                <x-a-sidenav href="{{ route('batch.dashboard') }}"
                :active="request()->routeIs('batch.dashboard') || request()->routeIs('batch.create') || request()->routeIs('batch.update')">
                        ...
                        <div class="w-full flex justify-between ">
                            <div class="flex space-x-2 ">
                                ...
                                @else
                                    <div
                                        class="flex text-sm border-2 border-transparent rounded-full focus:outline-none focus:border-gray-300 transition duration-150 ease-in-out">
                                        <svg class="h-8 w-8 rounded-full" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
